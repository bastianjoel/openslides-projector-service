...
func (m *User) SetRelatedJSON(field string, content []byte) error {
	switch field {
	case "vote_ids":
	...
	case "committee_management_ids":
		err := json.Unmarshal(content, &m.committeeManagements)
		if err != nil {
			return err
		}
	case "poll_voted_ids":
		err := json.Unmarshal(content, &m.pollVoteds)
		if err != nil {
			return err
		}
	case "is_present_in_meeting_ids":
		err := json.Unmarshal(content, &m.isPresentInMeetings)
		if err != nil {
			return err
		}
	case "meeting_user_ids":
	...
	case "delegated_vote_ids":
		err := json.Unmarshal(content, &m.delegatedVotes)
		if err != nil {
			return err
		}
	case "forwarding_committee_ids":
		err := json.Unmarshal(content, &m.forwardingCommittees)
		if err != nil {
			return err
		}
	case "gender_id":
		err := json.Unmarshal(content, &m.gender)
		if err != nil {
			return err
		}
	case "committee_ids":
